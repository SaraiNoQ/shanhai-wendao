...
function App() {
  ...
  return <div className="game-shell">
    ...
    {page === 'loadout' && <Suspense fallback={<main className="paper-page"><p>正在展开角色行囊……</p></main>}><CharacterPage save={save} readOnly={Boolean(trialRun || trialBattle || save.pendingTrialSettlement || save.campaign.pendingOfflineSettlement)} readOnlyReason={save.campaign.pendingOfflineSettlement ? '离线报告待领取，领取前暂不可调整角色。' : undefined} onSaveChange={handleCharacterChange} onEnterBattle={startBattle} /></Suspense>}
