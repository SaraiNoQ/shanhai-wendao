...
function App() {
  ...
  return <div className="game-shell">
    ...
    {page === 'loadout' && <Suspense fallback={<main className="paper-page"><p>正在展开角色行囊……</p></main>}><CharacterPage save={save} readOnly={Boolean(trialRun || trialBattle || save.pendingTrialSettlement)} onSaveChange={handleCharacterChange} onEnterBattle={startBattle} /></Suspense>}
